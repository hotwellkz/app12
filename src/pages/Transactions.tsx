...
import { AddEmployeeModal } from '../components/transactions/AddEmployeeModal';
...
export const Transactions: React.FC = () => {
  ...
  const [showAddWarehouseItemModal, setShowAddWarehouseItemModal] = useState(false);
    ...
    <DndContext onDragEnd={handleDragEnd}>
      <div className="p-2 sm:p-3 space-y-2">
        ...
        <CategoryRow
          ...
          onHistoryClick={handleHistoryClick}
          onAddCategory={() => setShowAddEmployeeModal(true)}
          rowNumber={2}
        />
        ...
        <CategoryRow
          ...
          onHistoryClick={handleHistoryClick}
          onAddCategory={() => setShowAddWarehouseItemModal(true)}
          rowNumber={4}
        />
      </div>
      ...
      <AddWarehouseItemModal
        isOpen={showAddWarehouseItemModal}
        onClose={() => setShowAddWarehouseItemModal(false)}
      />
    </DndContext>
  );
};